...
@export var texture_affine_mapping_strength : float = 1.0
...
@export var color_palette_strength : float = 1.0
...
@export var dithering_strength : float = 1.0
@export_group("Vertex")
@export var vertex_jitter_mode : VertexJitterMode = VertexJitterMode.ClipSpace
@export var vertex_jitter_strength : float = 15.0
@export var vertex_z_fighting_reduction : float = 0.0
@export_group("Fog")
...
@export var crt_curvature_strength : float = 3.15
@export var crt_chromatic_aberration_strength : float = 1.0
@export var crt_scanline_scale : float = 1.0
@export var crt_scanline_intensity : float = 0.5
@export var crt_vignette_radius : float = 0.35
@export var crt_vignette_softness : float = 0.4
@export_group("VHS")
@export var vhs_enabled : bool = false
@export var vhs_tracking_strength: float = 0.3
@export var vhs_tape_noise_intensity: float = 0.6
@export var vhs_chroma_bleeding_strength: float = 0.4
@export var vhs_tape_dropout_intensity: float = 0.15
@export var vhs_signal_ringing_strength: float = 0.3
